...
static const struct pinconf_param lan966x_pinconf_params[] = {
...
static int lan966x_pinconf_set(struct udevice *dev, unsigned int pin,
...
#if CONFIG_IS_ENABLED(PINCONF)
	.pinconf_num_params = ARRAY_SIZE(lan966x_pinconf_params),
	.pinconf_params = lan966x_pinconf_params,
	.pinconf_set = lan966x_pinconf_set,
#endif
};
